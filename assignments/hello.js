console.log("This is just a dummy file to know how git works");
console.log("I have given git init command in learning folder");
console.log("Then I added a folder assignments and did git add .");
